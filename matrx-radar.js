(function (global, factory) {
	...
	function p1x$1({goalRadius, centerX, startRadians}) {
		return centerX + (goalRadius * Math.sin(startRadians));
	}

	function p1y$1({goalRadius, centerY, startRadians}) {
		return centerY - (goalRadius * Math.cos(startRadians));
	}

	function p2x$1({goalRadius, centerX, endRadians}) {
		return centerX + (goalRadius * Math.sin(endRadians));
	}

	function p2y$1({goalRadius, centerY, endRadians}) {
		return centerY - (goalRadius * Math.cos(endRadians));
	}
	...
	function create_main_fragment$2(component, ctx) {
		...
		var if_block = (ctx.goal) && create_if_block$1(component, ctx);
