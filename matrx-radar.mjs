...
function create_main_fragment$3(component, ctx) {
	...
	return {
		c() {
			...
			setAttribute(rect, "x", "105");
			setAttribute(rect, "y", "40");
			setAttribute(rect, "width", "40");
			setAttribute(rect, "height", "20");
			setAttribute(rect, "fill", "red");
			setAttribute(text, "id", "ourText");
			setAttribute(text, "x", "125");
			setAttribute(text, "y", "50");
